...
extension UIView {
    func addBorder(color: UIColor = .clear, width: CGFloat = 0, radius: CGFloat = 0) {
    ...
    func addBorder(side: BorderSide) {
        self.addBorders(on: [side])
    }
    
    func addBorders(on sides: [BorderSide]) {
        for side in sides {
